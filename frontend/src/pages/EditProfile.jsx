...
function EditProfile() {
  ...
  const editProfile = async (id) => {
    ...
    if(json){
      setNotification({ message: "Profile Updated", type: 'success', status: 'true' })
      navigate('/myprofile')
    }
  ...
  return (
    <>
      ...
      <div className='p-10 bg-slate-100 w-full h-full'>
        ...
        <form action="" onSubmit={handleEdit} className='my-4 flex flex-col gap-3'>
          ...
          /> */}
          <br />
          <button className='bg-blue-700 hover:bg-blue-800 transition-all ease-in-out duration-200 h-14 text-center text-white font-medium hover:shadow-lg' type='submit'>SAVE CHANGES</button>
        </form>
      </div>
    </>
  )
